    ...
    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
        <thead>
            <tr class="fw-bolder text-muted">
                ...
                <th class="max-w-150px">Image</th>
                <th class="max-w-140px">Description</th>
                <th class="max-w-100px">Price</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text pe-0">
                    <img src="{{ asset('storage/'.$item->image) }}" alt="" style="width:50%">
                </td>
                <td class="text pe-0">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" aria-labelledby="aksi">
                            <div class="menu-item px-3">
                                <a href="javascript:;" onclick="load_input('{{route('rental.edit',$item->id)}}');" class="menu-link px-3">Ubah</a>
                            </div>
                            <div class="menu-item px-3">
                                <a href="javascript:;" onclick="handle_delete('{{route('rental.destroy',$item->id)}}');" class="menu-link px-3">Hapus</a>
                            </div>
                        </div>
                    </div>
                </td>
