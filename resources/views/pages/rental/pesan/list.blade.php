    ...
    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
        <thead>
            <tr class="fw-bolder text-muted">
                ...
                <th class="max-w-150px">Nama Mobil</th>
                <th class="max-w-140px">Status</th>
                <th class="max-w-140px">Aksi</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="fw-bolder text-dark">{{ $item->cars->name }}</span>
                </td>
                <td class="text pe-0">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" aria-labelledby="aksi">
                            <div class="menu-item px-3">
                                <a href="javascript:;" onclick="load_input('{{route('pesanrental.edit',$item->id)}}');" class="menu-link px-3">Ubah</a>
                            </div>
                            <div class="menu-item px-3">
                                <a href="javascript:;" onclick="handle_batal('{{route('pesanrental.destroy',$item->id)}}');" class="menu-link px-3">Batalkan Pesanan</a>
                            </div>
                        </div>
                    </div>
                </td>
